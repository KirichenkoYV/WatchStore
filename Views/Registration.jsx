    ...
    <html lang="en">
      ...
      <body className="bg-secondary">
        <form  className="container mt-2" method="POST" action="/admin">
          ...
          <input className="form-control mb-2 bg-light" name="login" id="loginInput" type="text" required />

          <label htmlFor="passwordInput">Password</label>
          <input className="form-control mb-2 bg-light" name="password" id="passwordInput" type="password" required />

          <button id="knopka" className="btn btn-default btn-m bg-info" type="submit">
            Subbmit
          </button>
        </form>
      </body>
